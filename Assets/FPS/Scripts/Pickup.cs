...
public class Pickup : MonoBehaviour
{
    ...
    {
        // Gets the player character controller from the player
        ...
        if (pickingPlayer != null)
        {
            if (onPick != null)
            {
                // sends a unity event to anyone who is listening — in this case, the health script on the same instance
